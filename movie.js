...
const APILINK = "https://796d55a5-5b26-4777-9acb-1ba3a3dd4d7f-00-13v5nc92yg9t2.spock.replit.dev/api/v1/reviews/";
        ...
        <div class="row">
          <div class="column">
            <div class="card" id="${review._id}">
              ...
              <p><a href="#" onclick="editReview('${review._id}', '${review.user}', '${review.review}')">Edit</a> <a href="#" onclick="deleteReview('${review._id}')">Delete</a></p>
            </div>
          </div>
        </div>
      `;
